...
export default function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside className="fixed top-0 left-0 bottom-0 w-[300px] bg-[#1a2332] z-50 overflow-y-auto p-6 glow-border lg:hidden">
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 p-2 rounded-lg bg-[#112240] hover:bg-[#1a2332] transition-colors"
        >
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-xs text-[#cbd5e1] bg-[#112240] px-3 py-2 rounded-lg inline-block">
            SElectrical System Designer | Graphics Designer | UI/UX Designer
          </p>
        </div>
          ...
          <div className="bg-[#112240] rounded-xl p-3 border border-[#00d9ff]/10">
            ...
            >
              <div className="bg-[#00d9ff]/10 p-2 rounded-lg group-hover:bg-[#00d9ff]/20 transition-colors">
                <Mail className="w-3 h-3 text-[#00d9ff]" />
              </div>
        ...
        <div className="flex justify-center gap-3">
          <a
            ...
            className="bg-[#112240] p-2 rounded-lg border border-[#00d9ff]/10 hover:border-[#00d9ff]/30 hover:scale-110 transition-all duration-200"
          >
          ...
          <a
            ...
            className="bg-[#112240] p-2 rounded-lg border border-[#00d9ff]/10 hover:border-[#00d9ff]/30 hover:scale-110 transition-all duration-200"
          >
            <Send className="w-4 h-4 text-[#cbd5e1]" />
          </a>
          <a
